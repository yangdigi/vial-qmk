...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = {
    { KC_ESC, KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS,KC_EQL, KC_BSPC,KC_HOME,KC_NO,  },
    ...
    { KC_LCTL,KC_LGUI,KC_LALT,KC_NO,  KC_NO,  KC_SPC, KC_NO,  KC_NO,  KC_NO,  KC_RALT,KC_RCTL,KC_NO,  KC_LEFT,KC_DOWN,KC_RGHT,KC_NO,  }
	},  
  [1] = {
