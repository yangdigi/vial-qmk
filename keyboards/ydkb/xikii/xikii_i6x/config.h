...
#define PRODUCT_ID      0x2166
#define DEVICE_VER      0x0001
#define MANUFACTURER    YDKB
#define PRODUCT         Xikii i6x (FW_VER)


/* key matrix size */
#define MATRIX_ROWS 10  //595
...
#define RGBLED_NUM 14     // Number of LEDs for calc
